...
/**
 * Quote Template Service - Mock Implementation
 *
 * Gestiona templates de cotizaciones usando localStorage
 * Para desarrollo offline sin backend Django
 */
...
export const quoteTemplateServiceMock = {
  /**
