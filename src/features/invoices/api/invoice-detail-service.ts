/**
 * Invoice Detail Service - Main Entry Point
 *
...
import { invoiceDetailServiceBackend } from './invoice-detail-service-backend'
import { invoiceDetailServiceMock } from './invoice-detail-service-mock'

/**
 * Servicio de invoice details principal
 *
 ...
 */
export const invoiceDetailService = featureFlags.useBackendAPI
  ? invoiceDetailServiceBackend
  : invoiceDetailServiceMock
