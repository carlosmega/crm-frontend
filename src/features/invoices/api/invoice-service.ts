...
import { invoiceServiceBackend } from './invoice-service-backend'
import { invoiceServiceMock } from './invoice-service-mock'

/**
 * Servicio de invoices principal
 *
 ...
 */
export const invoiceService = featureFlags.useBackendAPI
  ? invoiceServiceBackend
  : invoiceServiceMock
