/**
 * Contact Service - Main Entry Point
 *
...
import { contactServiceBackend } from './contact-service-backend'
import { contactServiceMock } from './contact-service-mock'

/**
 * Servicio de contactos principal
 *
 ...
 */
export const contactService = featureFlags.useBackendAPI
  ? contactServiceBackend
  : contactServiceMock
