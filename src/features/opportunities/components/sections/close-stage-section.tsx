 ...
 *
 * Contains all close-related fields:
 * - Actual Value & Close Date
 * - Win/Loss Documentation
 * - Competitor Information
 */
export function CloseStageSection() {
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="text-sm text-muted-foreground">
            Finalize the deal. Document the outcome and reasons. Use the "Close Opportunity" action to mark as Won or Lost.
          </div>
