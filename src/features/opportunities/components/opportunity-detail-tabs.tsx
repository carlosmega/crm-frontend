      ...
      <TabsContent value="general" className="mt-0">
        <div className="space-y-4">
          ...
          <div className="md:hidden grid grid-cols-2 gap-2">
            <button className="flex items-center justify-center gap-2 px-4 py-2.5 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 dark:bg-gray-800 transition-colors">
